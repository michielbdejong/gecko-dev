...
// TODO:
// * proper padding in md5 function
// * prepare PR for part except syncing
// * remove need for ./prepare.sh script
// * get kinto-scoped OAuth bearer token the proper way
// * find out why remoteTransformer is called multiple times
// * set strategy back to manual and get meaningful change events when resolving conflicts
// * work out the right way to start (and also stop) the sync timer
